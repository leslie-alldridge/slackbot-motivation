...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Provider__ = __webpack_require__(38);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(21), __webpack_require__(48)(module)))
...
function mapDispatchToProps(dispatch) {
  return {
    submitForm: function submitForm(form) {
      dispatch((0, _form.submitForm)(form));
    }
  };
}
...
function submitForm(form) {
  var req = { formdata: form };
  return function (dispatch) {
    (0, _api2.default)('post', '/form/save', req).then(function (response) {
      if (!response.ok) {
        console.log('error');
      } else {
...
function consume() {
  ...
  return _superagent2.default[method](baseUrl + endpoint).set(headers)[dataMethod](data).then(function (res) {
    return res;
  }).catch(function (err) {
    throw err;
  });
