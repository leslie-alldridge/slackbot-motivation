...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      _superagent2.default.get('https://api.wheretheiss.at/v1/satellites').then(function (data) {
        _this2.setState({
    ...
    key: 'clicker',
    value: function clicker(id) {
      var _this3 = this;

      _superagent2.default.get('https://api.wheretheiss.at/v1/satellites/' + id).then(function (data) {
        console.log(data);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.state.satellites.length > 0 && _react2.default.createElement(
          'ul',
          null,
          this.state.satellites.map(function (sat) {
            return _react2.default.createElement(
              'li',
              { key: sat.id },
              _react2.default.createElement(
        ...
        this.state.satData && _react2.default.createElement(
          'div',
          null,
